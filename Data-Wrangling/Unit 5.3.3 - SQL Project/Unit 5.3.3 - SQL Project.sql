...
SELECT name,
	   ...
	   CASE WHEN monthlymaintenance > 100 THEN 'expensive'
			WHEN monthlymaintenance < 100 THEN 'cheap' END AS maintenance_category
	FROM Facilities
...
SELECT 	CONCAT(m.surname, ', ', m.firstname) AS name,
		f.name as facililty_name,
		SUBSTR(b.starttime, 1, 10) AS day,
		CASE WHEN b.memid = 0 THEN f.guestcost*b.slots
			 ELSE f.membercost*b.slots END AS user_cost
...
SELECT *
	...
	FROM (
		...
		SELECT 	f.name as facililty_name,
